      ...
      <div className={AboutCSS.aboutPageBody}>
        <div className={AboutCSS.containerRow}>
          ...
          <p className={AboutCSS.p1}>
            ...
            {AboutJSON.businessa} <br />
            <br />
            <h4>{AboutJSON.bengalpurposeq}</h4>
            {AboutJSON.bengalpurposea}
            <br />
            <br />
          </p>
        ...
        <div className={AboutCSS.p3}>
          ...
          <h5>
            {" "}
            We will provide some documents with every kitten. Such as
            registration, health, and vaccination records. We take pride in
            giving every customer a healthy and joyful kitten. There might be
            some other supplies included as well, such as informational packets,
            limited amount of food, toys, training guide, etc.
          </h5>
        </div>
      </div>
      <Footer />
