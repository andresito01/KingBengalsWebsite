  ...
  return (
    <div className={ContactUsCSS.contactUsPage}>
      ...
      <div className={ContactUsCSS.bg}>
        <img
          alt="headerImage"
          src={require("../images/Sacramento-Downtown-Renaissance-Web-Banner (11).png")}
          width="1000"
        />
        <div className={ContactUsCSS.mainContentContainer}>
          ...
          <form
            className={ContactUsCSS.formContainer}
            ref={form}
            onSubmit={sendEmail}
          >
            <label id={ContactUsCSS.formLabel}>Name</label>
            <input
              id={ContactUsCSS.userName}
              type="text"
